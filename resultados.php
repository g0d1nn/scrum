...
<div class="container py-5">
    <h2 class="mb-4" style="color: #0b57a4; font-weight: 700;">
    ...
    <form method="GET" class="row g-3 mb-4 filter-row">
        ...
        <div class="col-12 d-flex gap-2">
            ...
            <a href="index.php" class="btn btn-outline-secondary"><i class="fa fa-arrow-left me-1"></i> Voltar</a>
        ...
        <?php else: ?>
            <div class="col-12">
                <div class="alert alert-info text-center" role="alert">
                    ...
                    <strong>Nenhuma organização encontrada</strong> com os filtros selecionados.
                    <br>
                    <small class="text-muted">Tente ajustar seus critérios de busca ou <a href="home.php#busca">volte à busca inicial</a>.</small>
                </div>
            </div>
        <?php endif; ?>
        </div>
